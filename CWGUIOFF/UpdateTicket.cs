...
namespace CWGUIOFF
{
    public partial class UpdateTicket : MetroFramework.Forms.MetroForm
    {
        public UpdateTicket()
        {
            InitializeComponent();
            from_combobox.SelectedIndexChanged += to_combobox_SelectedIndexChanged;
        ...
        private void UpdateTicket_Load(object sender, EventArgs e)
        {
            ...
            txt_cost.ReadOnly = true;     // COST BOX READ ONLY
        }
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrEmpty(txt_tiketnumber.Text) || string.IsNullOrEmpty(txt_name.Text) || string.IsNullOrEmpty(to_combobox.Text) ||
                    string.IsNullOrEmpty(from_combobox.Text) || string.IsNullOrEmpty(txt_email.Text) || string.IsNullOrEmpty(txt_telephone.Text))
                {
                ...
                con.Open();
                cmd = new SqlCommand("Update Passenger set  Passenger_Name= '" + txt_name.Text + "', Departure = '" + to_combobox.Text + "', Destination =  '" + from_combobox.Text + "', Cost = '" + txt_cost.Text + "', Email = '" + txt_email.Text + "', Passenger_TP= '" + txt_telephone.Text + "' where PassengerTicket_Id = '" + txt_tiketnumber.Text + "'", con);
                int i = cmd.ExecuteNonQuery();
                if (i == 1)
                {
                    MessageBox.Show("Data updated", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    string subject = "Updated Train Ticket Information";
                    string body = $"Dear {txt_name.Text},\n\nWe want to inform you that there has been an update to your train ticket.\n\nUpdated Ticket Number: {txt_tiketnumber.Text}\n\nIf you have any questions or concerns, please feel free to contact us.\n\nThank you for using RAIL PILOT.\n\nBest regards,\nThe RAIL PILOT Team";
                    ...
                    txt_tiketnumber.Clear();
                    to_combobox.ResetText();
                    from_combobox.ResetText();
                    txt_name.Clear();
                    txt_cost.Clear();
                    txt_email.Clear();
                    txt_telephone.Clear();
            ...
            {
                MessageBox.Show("Out of Memory Exception: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            catch (Exception ex)
            {
        ...
        private void to_combobox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (from_combobox.SelectedIndex == 1)
            {
            ...
            else if (from_combobox.SelectedIndex == 2)
            {
            ...
            else if (from_combobox.SelectedIndex == 3)
            {
            ...
            else if (from_combobox.SelectedIndex == 4)
            {
            ...
            else if (from_combobox.SelectedIndex == 5)
            {
            ...
            else if (from_combobox.SelectedIndex == 6)
            {
            ...
            else if (from_combobox.SelectedIndex == 7)
            {
            ...
            else if (from_combobox.SelectedIndex == 8)
            {
            ...
            else if (from_combobox.SelectedIndex == 9)
            {
            ...
            else if (from_combobox.SelectedIndex == 10)
            {
            ...
            else if (from_combobox.SelectedIndex == 11)
            {
            ...
            else if (from_combobox.SelectedIndex == 12)
            {
            ...
            else if (from_combobox.SelectedIndex == 13)
            {
            ...
            else if (from_combobox.SelectedIndex == 14)
            {
            ...
            else if (from_combobox.SelectedIndex == 15)
            {
            ...
            else if (from_combobox.SelectedIndex == 16)
            {
            ...
            else if (from_combobox.SelectedIndex == 17)
            {
            ...
            else if (from_combobox.SelectedIndex == 18)
            {
            ...
            else if (from_combobox.SelectedIndex == 19)
            {
            ...
            else if (from_combobox.SelectedIndex == 20)
            {
            ...
            else if (from_combobox.SelectedIndex == 21)
            {
            ...
            else if (from_combobox.SelectedIndex == 22)
            {
            ...
            else if (from_combobox.SelectedIndex == 23)
            {
        ...
        private void from_combobox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            int selectedIndex = from_combobox.SelectedIndex; // TO CHECK COMBO BOXES

            for (int i = 0; i < from_combobox.Items.Count; i++)
            {
                if (i != selectedIndex)
                {
                    to_combobox.Items.Add(from_combobox.Items[i]);
                }
            }
        }
    }
